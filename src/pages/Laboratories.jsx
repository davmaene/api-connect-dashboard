...
import { onDeleteItem, onLoadAllLabos, onLoadAllUsers } from '../helpers/helper.call';
...
export const LaboratoriesScreen = () => {
        ...
        onLoadAllLabos({
            ...
            callback: (err, done) => {
                ...
                if (done) {
                        ...
                        const { __tbl_province, __tbl_territory, __tbl_user, id } = d
                ...
                <Col xs={24} sm={24} className="mb-24">
                    <Card bordered={false} className="criclebox cardbody h-full">
                        <div className="project-ant">
                            <div>
                                <Title level={5}>Liste des laboratoires ( {list.length} )</Title>
                                <Paragraph className="lastweek">
                                    Liste des laboratoires {appname} | Dernière mis à jour <span className="blue" style={{ color: Colors.primaryColor }}>{now()}</span>
                                </Paragraph>
                            </div>
                            <div className="">

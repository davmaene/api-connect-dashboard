...
import { onDeleteItem, onLoadAllLabos, onLoadAllMarkets, onLoadAllProject, onLoadAllUsers } from '../helpers/helper.call';
        ...
        onLoadAllMarkets({
            ...
            callback: (err, done) => {
                ...
                if (done) {
                        ...
                        const { __tbl_province, __tbl_territory, id } = d
                ...
                <Col xs={24} sm={24} className="mb-24">
                    <Card bordered={false} className="criclebox cardbody h-full">
                        <div className="project-ant">
                            <div>
                                <Title level={5}>Liste des marchés ( {list.length} )</Title>
                                <Paragraph className="lastweek">
                                    Liste des marchés {appname} | Dernière mis à jour <span className="blue" style={{ color: Colors.primaryColor }}>{now()}</span>
                                </Paragraph>
                            </div>
                            <div className="">

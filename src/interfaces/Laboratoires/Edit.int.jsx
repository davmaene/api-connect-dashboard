...
import { onAddNewLabo, onAddNewUser, onEditLaboratory, onLoadAllLabos, onLoadAllProvinces, onLoadAllTerritoriesByProvinces, onLoadAllUsers, onLoadAllVillagesByTerritoire } from '../../helpers/helper.call';

const { Title } = Typography;
const { Option } = Select;

export const EditLaboInterface = ({ cb, current }) => {
                            ...
                            <Row gutter={[24, 0]}>
                                <Col span={8} md={8} >
                                    <Form.Item
                                        ...
                                        initialValue={current && current['labo']}
                                        rules={[
                                ...
                                <Col span={12} md={8} >
                                    <Form.Item
                                        ...
                                        initialValue={current && current['idresponsable']}
                                        rules={[

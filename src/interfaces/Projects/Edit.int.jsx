...
import { onAddNewLabo, onAddNewProject, onAddNewUser, onLoadAllLabos, onLoadAllProvinces, onLoadAllTerritoriesByProvinces, onLoadAllUsers, onLoadAllVillagesByTerritoire } from '../../helpers/helper.call';

const { Title } = Typography;
const { Option } = Select;

export const EditProjectsInterface = ({ cb, current }) => {
                        ...
                        >
                            <Row gutter={[24, 0]}>
                                <Col span={8} md={8} >
                                    ...
                                    >
                                        <Input size='large' placeholder="Nom du projet" />
                                    </Form.Item>
                                </Col>
                                <Col span={8} md={8}>
                                    <Form.Item
                            ...
                            <Row gutter={[24, 0]}>
                                <Col span={8} md={8} >
                                    <Form.Item
                                        ...
                                        rules={[
                                            { required: true, message: "Entrer le Budjet du projet" },
                                        ]}
                                    >
                                        <Input type='number' size='small' placeholder="Budjet du projet" suffix="   &nbsp;USD   &nbsp;" />
                                    </Form.Item>
                                </Col>
                                <Col span={8} md={8}>
                                    <Form.Item
                                        ...
                                        rules={[
                                            { required: true, message: "Entrer le taux d'interêt" },
                                        ]}
                                    >
                                        <Input type='number' size='small' placeholder="Entrer le taux d'interêt" suffix="   &nbsp;%   &nbsp;" />
                                    </Form.Item>
                                </Col>
                                <Col span={12} md={8} >
                                    <Form.Item
                                        ...
                                        rules={[
                                            { required: true, message: "Séléctionner l'echeance" },
                                        ]}
                                    >
                                        <Input type="number" size='small' placeholder="Séléctionner l'echeance" suffix="   &nbsp;Mois   &nbsp;" />
                                        {/* <Select size='large' placeholder="Séléctionner le responsable" >
                                            {users.map((v, i) => {
                                                return (
                                                    <Option value={`${v['id']}|${v['nom']} ${v['postnom']}`} >{`${v['nom']} ${v['postnom']} | ${v['phone']}`}</Option>
                            ...
                            <Row gutter={[24, 0]}>
                                ...
                                <Col span={12} md={8}>
                                    ...
                                    >
                                        <Select showSearch size='large' placeholder="Séléctionner la territoire" >
                                            {territoires.map((v, i) => {
                                                return (
                                ...
                                <Col span={12} md={8} >
                                    <Form.Item
                                        ...
                                        rules={[
                                            { required: true, message: "Etat du projet" },
                                        ]}
                                    >
                                        <Select size='large' placeholder="Séléctionner l'etat du projet" >
                                            {[{ id: 1, value: "Projet urgent" }, { id: 0, value: "Projet non urgent" }].map((v, i) => {
                                                return (
                                                    <Option value={`${v && v['id']}`} >{v && v['value']}</Option>
                                                )
                                            })}
                                        </Select>

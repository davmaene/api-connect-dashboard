...
import { onAddNewUser, onEditUser, onLoadAllLabos, onLoadAllProvinces, onLoadAllTerritoriesByProvinces, onLoadAllVillagesByTerritoire } from '../../helpers/helper.call';

const { Title } = Typography;
const { Option } = Select;

export const EditUserInterface = ({ cb, current }) => {
            ...
            onEditUser({
                ...
                callback: (err, done) => {
                    ...
                    if (done) {
                        ...
                        message.error("Une erreur veint de se produire lors de la modification d'un utilisateur !")
                        return cb(false)
                    }
                }
            })
                            ...
                            <Row gutter={[24, 0]}>
                                ...
                                <Col span={8} md={8}>
                                    <Form.Item
                                        ...
                                        name="postnom"
                                        label="Postnom"
                                        initialValue={current && current['postnom']}
                                        rules={[
                                ...
                                <Col span={8} md={8}>
                                    <Form.Item
                                        ...
                                        name="prenom"
                                        label="Prenom"
                                        initialValue={current && current['prenom']}
                                        rules={[
                            ...
                            <Row gutter={[24, 0]}>
                                <Col span={12} md={12} >
                                    <Form.Item
                                        ...
                                        name="genre"
                                        label="Genre | Sexe"
                                        initialValue={current && current['genre']}
                                        rules={[
                                ...
                                <Col span={12} md={12} >
                                    <Form.Item
                                        className='w-100 pt-1'
                                        name="adresse"
                                        initialValue={current && current['adresse']}
                                        ...
                                        {belongsToAssoc &&
                                            (
                                                <Form.Item
                                                    className='w-100 pt-1'
                                                    name="idlabo"
                                                    initialValue={current && current['idlabo']}
                                                    rules={[
                            ...
                            <Row gutter={[24, 0]}>
                                <Col span={12} md={8} >
                                    <Form.Item
                                        ...
                                        name="idprovince"
                                        label="Province"
                                        initialValue={current && current['idprovince']}
                                        rules={[
                                ...
                                <Col span={12} md={8}>
                                    <Form.Item
                                        ...
                                        name="idterritoire"
                                        label="Territoire"
                                        initialValue={current && current['idterritoire']}
                                        rules={[
                                ...
                                <Col span={12} md={8} >
                                    <Form.Item
                                        ...
                                        initialValue={current && current['idvillage']}
                                        rules={[

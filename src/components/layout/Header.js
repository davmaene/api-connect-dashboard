...
import soko from "../../assets/images/statics/soko.png"
import invest from "../../assets/images/statics/invest.png"
import lab from "../../assets/images/statics/lab.png"
...
const items = [
  {
    ...
    label: (
      <>
        ...
        >
          <div className="col-3" >
            <Avatar shape="square">{bell}</Avatar>
          </div>
          <div className="col-9">
...
const menu = (
  <List
    min-width="100%"
    className="header-notifications-dropdown w-100"
          ...
          >
            <div layout="vertical">
              <div className="header-top">
                <Title level={4}>
                  Applications
                  <Text className="subtitle">Séléctionner une application avant de continuer</Text>
                </Title>
              </div>
              ...
              <div className="sidebar-color">
                <div className="sidebarnav-color mb-2">
                  ...
                  <Text>Liste des applications de {appname} fournies par {appcompanyname}</Text>
                  <div style={{ marginTop: 20 }}>
                    <Button
                      ...
                      onClick={(e) => {
                        onChangeRoom({ e: 8495, event: e })
                      }}
                    >
                      <img src={invest} style={{ width: 50, height: 50, position: "absolute", left: 10 }} />
                      <span>Mukulima Invest</span>
                    </Button>
                    <Button
                      type={"default"}
                      style={{
                      ...
                      onClick={(e) => {
                        onChangeRoom({ e: 8496, event: e })
                      }}
                    >
                      <img src={soko} style={{ width: 50, height: 50, position: "absolute", left: 10 }} />
                      <span>Mukulima Soko</span>
                    </Button>
                    <Button
                      type={"default"}
                      style={{
                      ...
                      onClick={(e) => {
                        onChangeRoom({ e: 8497, event: e })
                      }}
                    >
                      <img src={lab} style={{ width: 50, height: 50, position: "absolute", left: 10 }} />
                      <span>Mukulima Lab</span>
                    </Button>
                  </div>
                </div>
              </div>
